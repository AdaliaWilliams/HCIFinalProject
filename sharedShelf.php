...
<main class="categories">
    <section class="produce">
        <h2><a href="sharedProduce.php">Produce</a></h2>

    </section>
    <section class="dairy">
        <h2><a href="sharedDairy.php">Dairy</a></h2>

    </section>
    <section class="frozen">
        <h2><a href="sharedFrozen.php">Frozen</a></h2>

    </section>
    <section class="protein">
        <h2><a href="sharedProtein.php">Protein</a></h2>

    </section>
    <section class="shelf-safe">
        <h2><a href="sharedShelfSafe.php">Shelf Safe</a></h2>
...
<nav>
    ...
    <a href="addCategory.php"><img src="images/add_button.jpg"></a>
